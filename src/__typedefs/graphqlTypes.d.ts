...
declare global {
  namespace GQL {
    ...
    export interface AuthPayloadTypeResolver<TParent = any> {
      userErrors?: AuthPayloadToUserErrorsResolver<TParent>;
      data?: AuthPayloadToDataResolver<TParent>;
    }
    
    export interface AuthPayloadToUserErrorsResolver<TParent = any, TResult = any> {
      (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
    }
    
    export interface AuthPayloadToDataResolver<TParent = any, TResult = any> {
      (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
    }
    ...
    export interface PostAuthPayloadTypeResolver<TParent = any> {
      userErrors?: PostAuthPayloadToUserErrorsResolver<TParent>;
      data?: PostAuthPayloadToDataResolver<TParent>;
    }
    
    export interface PostAuthPayloadToUserErrorsResolver<TParent = any, TResult = any> {
      (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
    }
    
    export interface PostAuthPayloadToDataResolver<TParent = any, TResult = any> {
      (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
    }
